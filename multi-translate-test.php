...
$command = "cd /Volumes/Data/projects/test.af && php artisan ai-translator:translate-file modules/libraries/laravel-ai-translator/temp.php --target-language={$targetLanguage} --source-language=en --debug -vvv && cd modules/libraries/laravel-ai-translator";
