...
- 🔁 **Parallel Translation**: Translate multiple locales concurrently with the `translate-parallel` command. Crowdin projects can also be translated in parallel using `translate-crowdin-parallel`.
